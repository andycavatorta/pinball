...
class Main(threading.Thread):
    ...
    def run(self):
        while True:
            ...
            time.sleep(1)
            self.controllers.macros["carousel_2"].set_speed(30)
            time.sleep(1)
            self.controllers.macros["carousel_3"].set_speed(30)
            time.sleep(1)
            self.controllers.macros["carousel_4"].set_speed(30)
            time.sleep(1)
            self.controllers.macros["carousel_5"].set_speed(30)
            time.sleep(1)
            self.controllers.macros["carousel_6"].set_speed(30)
            time.sleep(1)
            self.controllers.macros["carousel_1"].set_speed(-30)
            time.sleep(1)
            self.controllers.macros["carousel_2"].set_speed(-30)
