...
class Main(threading.Thread):
    def __init__(self):
        ...
        self.controllers.macros["carousel_5"].set_speed(0)
        self.controllers.macros["carousel_6"].set_speed(0)
        self.start()
    ...
    def run(self):
        while True:
            ...
            self.controllers.macros["carousel_6"].set_speed(0)
            time.sleep(1)
            self.controllers.macros["carousel_1"].sset_speed(-10)
            time.sleep(1)
            self.controllers.macros["carousel_2"].sset_speed(-10)
            time.sleep(1)
            self.controllers.macros["carousel_3"].sset_speed(-10)
            time.sleep(1)
            self.controllers.macros["carousel_4"].sset_speed(-10)
            time.sleep(1)
            self.controllers.macros["carousel_5"].sset_speed(-10)
            time.sleep(1)
            self.controllers.macros["carousel_6"].sset_speed(-10)
            time.sleep(1)
            self.controllers.macros["carousel_1"].set_speed(0)
            self.controllers.macros["carousel_2"].set_speed(0)
            self.controllers.macros["carousel_3"].set_speed(0)
