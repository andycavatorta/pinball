...
class Fake_Attraction_Mode(threading.Thread):
    ...
    def run(self):
        while True:
            ...
            time.sleep(3)
            self.tb.publish("playfield_lights",["trail_rollover_right","back_stroke_off"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_rollover_right","sparkle"], self.gamestation_names[2])
            time.sleep(2)
            self.tb.publish("playfield_lights",["trail_rollover_left","back_stroke_off"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_rollover_left","sparkle"], self.gamestation_names[2])
            time.sleep(1.8)
            self.tb.publish("playfield_lights",["trail_sling_right","back_stroke_off"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_sling_right","sparkle"], self.gamestation_names[2])
            time.sleep(1.6)
            self.tb.publish("playfield_lights",["trail_sling_left","back_stroke_off"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_sling_left","sparkle"], self.gamestation_names[2])
            time.sleep(1.4)
            self.tb.publish("playfield_lights",["trail_pop_left","back_stroke_off"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_pop_left","sparkle"], self.gamestation_names[2])
            time.sleep(1.2)
            self.tb.publish("playfield_lights",["trail_pop_right","back_stroke_off"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_pop_right","sparkle"], self.gamestation_names[2])
            time.sleep(1)
            self.tb.publish("playfield_lights",["trail_pop_center","back_stroke_off"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_pop_center","sparkle"], self.gamestation_names[2])
            time.sleep(0.8)
            self.tb.publish("playfield_lights",["trail_spinner","back_stroke_off"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_spinner","sparkle"], self.gamestation_names[2])
            time.sleep(0.6)

            self.tb.publish("playfield_lights",["pie_rollover_right","on"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_rollover_left","on"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_sling_right","on"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_sling_left","on"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_pop_left","on"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_pop_right","on"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_pop_center","on"], self.gamestation_names[2])
            self.tb.publish("playfield_lights",["pie_spinner","on"], self.gamestation_names[2])
