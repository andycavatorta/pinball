...
class Main(threading.Thread):
    ...
    def __init__(self):
        ...
        self.mode_error = Mode_Error(self.tb, self.hosts, self.mode_names, self.set_current_mode)
        self.mode_waiting_for_connections = Waiting_For_Connections(self.tb, self.hosts, self.mode_names, self.set_current_mode)
        self.mode_system_test = Mode_System_Tests(self.tb, self.hosts, self.mode_names, self.set_current_mode)
        self.mode_inventory = Mode_Inventory(self.tb, self.hosts, self.mode_names, self.set_current_mode)
        self.mode_reset = Mode_Reset(self.tb, self.hosts, self.mode_names, self.set_current_mode)
        self.mode_attraction = Mode_Attraction(self.tb, self.hosts, self.mode_names, self.set_current_mode)
        self.mode_countdown = Mode_Countdown(self.tb, self.hosts, self.mode_names, self.set_current_mode)
        self.mode_barter_intro = Mode_Barter_Intro(self.tb, self.hosts, self.mode_names, self.set_current_mode)
        self.mode_barter = Mode_Barter(self.tb, self.hosts, self.mode_names, self.set_current_mode)
        self.mode_money_intro = Mode_Money_Intro(self.tb, self.hosts, self.mode_names, self.set_current_mode)
        self.mode_money = Mode_mone(self.tb, self.hosts, self.mode_names, self.set_current_mode)
        self.mode_ending = Mode_ending(self.tb, self.hosts, self.mode_names, self.set_current_mode)

        self.send_to_dashboard = dashboard.init(self.tb)
        self.current_mode_name = ""
        self.current_mode = ""
        self.set_current_mode(self.mode_names.WAITING_FOR_CONNECTIONS)
        self.start()
