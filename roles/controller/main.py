    ...
    def run(self):
        while True:
            ...
            for station_ordinal in range(6):
                ...
                self.tb.publish("playfield_lights",["trail_rollover_right","back_stroke_on"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["trail_rollover_left","back_stroke_on"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["trail_sling_right","back_stroke_on"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["trail_sling_left","back_stroke_on"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["trail_pop_left","back_stroke_on"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["trail_pop_right","back_stroke_on"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["trail_pop_center","back_stroke_on"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["trail_spinner","back_stroke_on"], self.gamestation_names[station_ordinal])

                self.tb.publish("playfield_lights",["pie_rollover_right","sparkle"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["pie_rollover_left","sparkle"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["pie_sling_right","sparkle"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["pie_sling_left","sparkle"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["pie_pop_left","sparkle"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["pie_pop_right","sparkle"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["pie_pop_center","sparkle"], self.gamestation_names[station_ordinal])
                self.tb.publish("playfield_lights",["pie_spinner","sparkle"], self.gamestation_names[station_ordinal])
