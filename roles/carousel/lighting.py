...
class Lights(threading.Thread):
    class pattern_channels():
        ...
        PATH_COCO_NARANJA_CURVE_START = [16,19, 16,18, 16,17, 15,14, 12,13]
        PATH_COCO_NARANJA_CURVE_BOTH = [16,19, 16,18, 16,17, 15,14, 15,13, 15,12]
        PATH_COCO_NARANJA_CURVE_END = [19,18, 16,17, 15,14, 15,13, 15,12]
        PATH_COCO_MANGO_CURVE_START = [16,19, 16,18, 16,17, 15,14, 12,13, 11,10, 8,9]
        PATH_COCO_MANGO_CURVE_BOTH = [16,19, 16,18, 16,17, 15,14, 12,13, 11,10, 11,9, 11,8]
        PATH_COCO_MANGO_CURVE_END = [19,18, 16,17, 15,14, 12,13, 11,10, 11,9, 11,8]
        PATH_COCO_SANDIA_CURVE_START = [19,16, 19,17, 19,18, 20,21, 23,22, 0,1, 3,2]
        PATH_COCO_SANDIA_CURVE_BOTH = [19,16, 19,17, 19,18, 20,21, 23,22, 0,1, 0,2, 0,3]
        PATH_COCO_SANDIA_CURVE_END = [16,17, 19,18, 20,21, 23,22, 0,1, 0,2, 0,3]
        PATH_COCO_PINA_CURVE_START = [19,16, 19,17, 19,18, 20,21, 23,22]
        PATH_COCO_PINA_CURVE_BOTH = [19,16, 19,17, 19,18, 20,21, 20.22, 20,23]
        PATH_COCO_PINA_CURVE_END = [16,17, 19,18, 20,21, 20.22, 20,23]

        PATH_NARANJA_MANGO_CURVE_START = [12,15, 12,14, 12,13, 11,10, 8,9]
        PATH_NARANJA_MANGO_CURVE_BOTH = [12,15, 12,14, 12,13, 11,10, 11,9, 11,8]
        PATH_NARANJA_MANGO_CURVE_END = [15,14, 12,13, 11,10, 11,9, 11,8]
        PATH_NARANJA_SANDIA_CURVE_START = [12,15, 12,14, 12,13, 11,10, 8,9, 3,2, 0.1]
        PATH_NARANJA_SANDIA_CURVE_BOTH = [12,15, 12,14, 12,13, 11,10, 8,9, 3,2, 3,1, 3,0]
        PATH_NARANJA_SANDIA_CURVE_END = [  12,13, 11,10, 8,9, 3,2, 3,1, 3,0]
        PATH_NARANJA_COCO_CURVE_START = [ 15,12, 15,13, 15,14, 16,17, 19,18]
        PATH_NARANJA_COCO_CURVE_BOTH = [15,12, 15,13, 15,14, 16,17, 16,18, 16,19]
        PATH_NARANJA_COCO_CURVE_END = [12,13, 15,14, 16,17, 16,18, 16,19]
        PATH_NARANJA_PINA_CURVE_START = [15,12, 15,13, 15,14, 16,17, 19,18, 20,21, 23,22]
        PATH_NARANJA_PINA_CURVE_BOTH = [15,12, 15,13, 15,14, 16,17, 19,18, 20,21, 20,22, 20,23]
        PATH_NARANJA_PINA_CURVE_END = [12,13, 15,14, 16,17, 19,18, 20,21, 20,22, 20,23]

        PATH_MANGO_COCO_CURVE_START = [11,8, 11,9, 11,10, 12,13, 15,14, 16,17, 18,17]
        PATH_MANGO_COCO_CURVE_BOTH = [11,8, 11,9, 11,10, 12,13, 15,14, 16,17, 16,18, 16,19]
        PATH_MANGO_COCO_CURVE_END = [8,9, 11,10, 12,13, 15,14, 16,17, 16,18, 16,19]
        PATH_MANGO_NARANJA_CURVE_START = [11,8, 11,9, 11,10, 12,13, 15,14]
        PATH_MANGO_NARANJA_CURVE_BOTH = [11,8, 11,9, 11,10, 12,13, 12,14, 12,15]
        PATH_MANGO_NARANJA_CURVE_END = [8,9, 11,10, 12,13, 12,14, 12,15]
        PATH_MANGO_SANDIA_CURVE_START = [8,11, 8,10, 8,9, 3,2, 0,1]
        PATH_MANGO_SANDIA_CURVE_BOTH = [8,11, 8,10, 8,9, 3,2, 3,1, 3,0]
        PATH_MANGO_SANDIA_CURVE_END = [11,10, 8,9, 3,2, 3,1, 3,0]
        PATH_MANGO_PINA_CURVE_START = []
        PATH_MANGO_PINA_CURVE_BOTH = [8,11, 8,10, 8,9, 3,2, 0,1, 23,22, 23,21, 23,20]
        PATH_MANGO_PINA_CURVE_END = []

        PATH_SANDIA_COCO_CURVE_START = []
        PATH_SANDIA_COCO_CURVE_BOTH = []
        PATH_SANDIA_COCO_CURVE_END = []
        PATH_SANDIA_NARANJA_CURVE_START = []
        PATH_SANDIA_NARANJA_CURVE_BOTH = []
        PATH_SANDIA_NARANJA_CURVE_END = []
        PATH_SANDIA_MANGO_CURVE_START = []
        PATH_SANDIA_MANGO_CURVE_BOTH = []
        PATH_SANDIA_MANGO_CURVE_END = []
        PATH_SANDIA_PINA_CURVE_START = []
        PATH_SANDIA_PINA_CURVE_BOTH = []
        PATH_SANDIA_PINA_CURVE_END = []

        PATH_PINA_COCO_CURVE_START = []
        PATH_PINA_COCO_CURVE_BOTH = []
        PATH_PINA_COCO_CURVE_END = []
        PATH_PINA_NARANJA_CURVE_START = []
        PATH_PINA_NARANJA_CURVE_BOTH = []
        PATH_PINA_NARANJA_CURVE_END = []
        PATH_PINA_MANGO_CURVE_START = []
        PATH_PINA_MANGO_CURVE_BOTH = []
        PATH_PINA_MANGO_CURVE_END = []
        PATH_PINA_SANDIA_CURVE_START = []
        PATH_PINA_SANDIA_CURVE_BOTH = []
        PATH_PINA_SANDIA_CURVE_END = []
    ...
    def run(self):
        while True:
            ...
            print("++++++ 1",level, channel_numbers)
            for channel_number in channel_numbers:
                print("++++++ 2",level, channel_numbers)
