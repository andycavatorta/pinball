...
class Lights(threading.Thread):
    class pattern_channels():
        ...
        PATH_COCO_SANDIA_CURVE_END = []
        PATH_COCO_PINA_CURVE_START = [19,16, 19,17, 19,18, 20,21, 23,22]
        PATH_COCO_PINA_CURVE_BOTH = [19,16, 19,17, 19,18, 20,21, 20.22, 20,23]
        PATH_COCO_PINA_CURVE_END = []

        PATH_NARANJA_COCO_CURVE_START = []
        PATH_NARANJA_COCO_CURVE_BOTH = []
        PATH_NARANJA_COCO_CURVE_END = []
        PATH_NARANJA_MANGO_CURVE_START = []
        PATH_NARANJA_MANGO_CURVE_BOTH = []
        PATH_NARANJA_MANGO_CURVE_END = []
        PATH_NARANJA_SANDIA_CURVE_START = []
        PATH_NARANJA_SANDIA_CURVE_BOTH = []
        PATH_NARANJA_SANDIA_CURVE_END = []
        PATH_NARANJA_PINA_CURVE_START = []
        PATH_NARANJA_PINA_CURVE_BOTH = []
        PATH_NARANJA_PINA_CURVE_END = []

        PATH_MANGO_COCO_CURVE_START = []
        PATH_MANGO_COCO_CURVE_BOTH = []
        PATH_MANGO_COCO_CURVE_END = []
        PATH_MANGO_NARANJA_CURVE_START = []
        PATH_MANGO_NARANJA_CURVE_BOTH = []
        PATH_MANGO_NARANJA_CURVE_END = []
        PATH_MANGO_SANDIA_CURVE_START = []
        PATH_MANGO_SANDIA_CURVE_BOTH = []
        PATH_MANGO_SANDIA_CURVE_END = []
        PATH_MANGO_PINA_CURVE_START = []
        PATH_MANGO_PINA_CURVE_BOTH = []
