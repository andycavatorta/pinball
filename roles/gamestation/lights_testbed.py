...
def test_simple():
    while True:
        ...
        time.sleep(0.5)
        lights.trail_sling_right.on()
        time.sleep(0.5)
        lights.trail_sling_left.on()
        time.sleep(0.5)
        lights.trail_pop_left.on()
        time.sleep(0.5)
        lights.trail_pop_right.on()
        time.sleep(0.5)
        lights.trail_pop_middle.on()
        time.sleep(0.5)
        lights.trail_spinner.on()
        time.sleep(0.5)
        lights.pie_rollover_right.on()
        time.sleep(0.5)
        lights.pie_rollover_left.on()
        ...
        lights.pie_spinner.on()
        time.sleep(0.5)
        lights.sign_arrow_left.on()
        time.sleep(0.5)
        lights.sign_arrow_right.on()
        time.sleep(0.5)
        lights.sign_bottom_right.on()
        time.sleep(0.5)
        lights.sign_top .on()
        time.sleep(0.5)
