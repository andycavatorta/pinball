...
def test_simple():
    while True:
        lights.trail_rollover_right = Lights_Pattern(self.pattern_channels.TRAIL_ROLLOVER_RIGHT, self.queue)
        time.sleep(0.5)
        lights.trail_rollover_left = Lights_Pattern(self.pattern_channels.TRAIL_ROLLOVER_LEFT, self.queue)
        time.sleep(0.5)
        lights.trail_sling_right = Lights_Pattern(self.pattern_channels.TRAIL_SLING_RIGHT, self.queue)
        time.sleep(0.5)
        lights.trail_sling_left = Lights_Pattern(self.pattern_channels.TRAIL_SLING_LEFT, self.queue)
        time.sleep(0.5)
        lights.trail_pop_left = Lights_Pattern(self.pattern_channels.TRAIL_POP_LEFT, self.queue)
        time.sleep(0.5)
        lights.trail_pop_right = Lights_Pattern(self.pattern_channels.TRAIL_POP_RIGHT, self.queue)
        time.sleep(0.5)
        lights.trail_pop_middle = Lights_Pattern(self.pattern_channels.TRAIL_POP_CENTER, self.queue)
        time.sleep(0.5)
        lights.trail_spinner = Lights_Pattern(self.pattern_channels.TRAIL_SPINNER, self.queue)
        time.sleep(0.5)
        lights.pie_rollover_right = Lights_Pattern(self.pattern_channels.PIE_ROLLOVER_RIGHT, self.queue)
        time.sleep(0.5)
        lights.pie_rollover_left = Lights_Pattern(self.pattern_channels.PIE_ROLLOVER_LEFT, self.queue)
        time.sleep(0.5)
        lights.pie_sling_right = Lights_Pattern(self.pattern_channels.PIE_SLING_RIGHT, self.queue)
        time.sleep(0.5)
        lights.pie_sling_left = Lights_Pattern(self.pattern_channels.PIE_SLING_LEFT, self.queue)
        time.sleep(0.5)
        lights.pie_pop_left = Lights_Pattern(self.pattern_channels.PIE_POP_LEFT, self.queue)
        time.sleep(0.5)
        lights.pie_pop_right = Lights_Pattern(self.pattern_channels.PIE_POP_RIGHT, self.queue)
        time.sleep(0.5)
        lights.pie_pop_middle = Lights_Pattern(self.pattern_channels.PIE_POP_CENTER, self.queue)
        time.sleep(0.5)
        lights.pie_spinner = Lights_Pattern(self.pattern_channels.PIE_SPINNER, self.queue)
        time.sleep(0.5)
        lights.sign_arrow_left = Lights_Pattern(self.pattern_channels.SIGN_ARROW_LEFT, self.queue)
        time.sleep(0.5)
        lights.sign_arrow_right = Lights_Pattern(self.pattern_channels.SIGN_ARROW_RIGHT, self.queue)
        time.sleep(0.5)
        lights.sign_bottom_right = Lights_Pattern(self.pattern_channels.SIGN_BOTTOM_RIGHT, self.queue)
        time.sleep(0.5)
        lights.sign_top = Lights_Pattern(self.pattern_channels.SIGN_TOP, self.queue)
        time.sleep(0.5)
